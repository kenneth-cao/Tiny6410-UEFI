...
#define TT_DESCRIPTOR_PAGE_BASE_ADDRESS 0UL
#define TT_DESCRIPTOR_SECTION_BASE_SHIFT 0UL
#define TT_DESCRIPTOR_CONVERT_TO_PAGE_CACHE_POLICY 0UL
#define TT_DESCRIPTOR_CONVERT_TO_PAGE_AP 0UL
#define TT_DESCRIPTOR_SECTION_PAGETABLE_ADDRESS_MASK 0UL
#define TRANSLATION_TABLE_PAGE_COUNT 0UL
#define TT_DESCRIPTOR_PAGE_TYPE_MASK 0UL
#define TT_DESCRIPTOR_CONVERT_TO_PAGE_CACHE_POLICY 0UL
#define TT_DESCRIPTOR_CONVERT_TO_PAGE_CACHE_POLICY 0UL*/
