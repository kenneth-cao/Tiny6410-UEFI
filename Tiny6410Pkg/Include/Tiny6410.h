...
#define DMC_DDR_CAS_LATENCY               (DDR_CASL<<1)         // Set Cas Latency to 3
...
// Stepping Store (8KB)
#define SOC_STEPPING_STONE_PHYSICAL_BASE       0x0C000000
#define SOC_STEPPING_STONE_PHYSICAL_LENGTH     0x2000

// SoC registers   
#define SOC_REGISTERS_PHYSICAL_BASE       0x70000000
#define SOC_REGISTERS_PHYSICAL_LENGTH     0x10000000
