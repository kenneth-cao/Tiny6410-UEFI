...
{
  UINT32 LSR = UartBase(PcdGet32(PcdTiny6410ConsoleUart)) + UART_LSR_REG;
...
{
  UINT32  LSR = UartBase(PcdGet32(PcdTiny6410ConsoleUart)) + UART_LSR_REG;
  UINT32  RBR = UartBase(PcdGet32(PcdTiny6410ConsoleUart)) + UART_RBR_REG;
  CHAR8   Char;
...
{
  UINT32  LSR = UartBase(PcdGet32(PcdTiny6410ConsoleUart)) + UART_LSR_REG;
  UINT32  THR = UartBase(PcdGet32(PcdTiny6410ConsoleUart)) + UART_THR_REG;
